...
var lCreatePagesList = function (specification, title, volumes) {
  var result = {};
...
export default {
  ...
  specifications: {
    ...
    'lel.mymanga.io': {
      extension: 'jpg',
      pageURL: 'http://lel.mymanga.io/${title}/${chapter}/${title}_c${chapter}a_${page}.${extension}',
      chapterRule: 'fixed2',
      pageRule: 'fixed2'
    }
  },
  ...
  createPagesList: function (specification, title, volumes) {
    ...
    return lCreatePagesList(specification, title, volumes);
  },
